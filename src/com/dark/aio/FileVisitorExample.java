...
class FileVisitorExample {
	public static void main(String[] args) throws IOException {
		...
		// Create our FileVisitor implementation by overriding two of the
		// methods defined in
		// SimpleFileVisitor.
	...
	// This method creates the directory tree for the example under the current
	// directory
